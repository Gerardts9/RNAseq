...
genes2 <- fread("C://Users/Gerard/Desktop/AAA/RNAseq/Annotation/gencode.v34.annotation.fixed.gtf.gz")
...
Male <- ggplot()  +
  theme_bw() +
  geom_text(data = counts.sex.log.scaled, aes(x=XIST, y=Chromosome_Y, label=ID, color=Pheno.Sex)) +
...
```{r}
g <- arrangeGrob(Male, Female, nrow = 2)
ggsave(file="C://Users/Gerard/Downloads/Sex_Identification.png", g)
```
