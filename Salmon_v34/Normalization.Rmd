...
### Perform PCA:
```{r}
my_pca <- prcomp(t(dge), center = T, scale. = T)
...
```{r, include=TRUE}
ggbiplot(my_pca, labels = colnames(dgeTpmAdjCpm), groups = cc, var.axes = F, obs.scale = 1, var.scale = 1) +
