...
paste0("We keep ", sum(keep), " genes") # 10,640
paste0("We remove ", sum(!keep), " genes") # 26,072
...
Results_Salmon <- Results_Salmon[order(Results_Salmon$pvalue),]
#write.xlsx(Results_Salmon[order(Results_Salmon$pvalue), ][1:10,],"C://Users/Gerard/Desktop/AAA/RNAseq/TopTable.xlsx", rowNames = TRUE )

nrow(Results_Salmon[Results_Salmon$fdr < 0.05,])
Results_Salmon[Results_Salmon$fdr < 0.05,]
```
