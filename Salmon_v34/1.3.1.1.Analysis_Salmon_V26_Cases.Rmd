...
Results.V26 <- Results.V26[order(Results.V26$fdr),]

#write.xlsx(Results[order(Results$pvalue), ][1:76,], "C://Users/Gerard/Desktop/AAA/RNAseq/GitHub/TopTable_Diameter.xlsx", rowNames = TRUE)
nrow(Results.V26[Results.V26$fdr < 0.05,])
Results.V26
```
