...
```{r}
tec <- tec[tec$SampleID %in% colnames(cases.tpm), ]
...
colnames(Correlations) <- c("DATE","PLATE","GC_MEAN","RIN","DV200","QUBIT")

write.xlsx(as.data.frame(Correlations), "C://Users/Gerard/Desktop/AAA/RNAseq/Corr_Tec_Cases_Exh.xlsx", sep = "\t", rowNames = T)
```
