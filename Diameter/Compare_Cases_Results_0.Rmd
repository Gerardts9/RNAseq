...
```{r}
Salmon.v26 <- fread("C://Users/Gerard/Desktop/AAA/RNAseq/DEG_Diameter/Salmon.V26_0.txt")
Salmon.v26 <- Salmon.v26 %>% remove_rownames %>% column_to_rownames(var="V1")

Salmon.v34 <- fread("C://Users/Gerard/Desktop/AAA/RNAseq/DEG_Diameter/Salmon.V34_0.txt")
...
Salmon.v34.Exh <- fread("C://Users/Gerard/Desktop/AAA/RNAseq/DEG_Diameter/Salmon.V34_Exh_0.txt")
...
```{r}
common <- intersect(intersect(intersect(rownames(Salmon.v26), rownames(Salmon.v34)), rownames(RSEM.v26)), rownames(Salmon.v34.Exh)) # 9,948.
...
```{r}
common.row <- intersect(intersect(rownames(counts.Sal.V26), rownames(counts.Sal.V34)), rownames(counts.RSEM.V26)) # 26,899
common.col <- intersect(intersect(colnames(counts.Sal.V26), colnames(counts.Sal.V34)), colnames(counts.RSEM.V26)) 
```
