...
```{r}
ff <- list.files("/home/gerard/AAA/Results_Salmon2", pattern = ".genes.sf", recursive = T, full.names = T)
...
#fwrite(counts_tpm, "/home/gerard/AAA/Gene_Counts/Counts.Salmon.V26.txt", sep = "\t", row.names = T)
```
